...
export const BackgroundCircles = memo<BackgroundCirclesProps>(({ children }) => {
  return (
    <div className="absolute top-0 left-0 right-0 h-[560px] flex items-end justify-center opacity-100 pointer-events-none">
      ...
      <div className="absolute w-[360px] h-[360px] border border-white/10 rounded-full" />
    </div>
  );
});
