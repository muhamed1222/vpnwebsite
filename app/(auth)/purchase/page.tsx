...
export default function PurchasePage() {
  ...
  return (
    <main className="min-h-[var(--tg-viewport-height,100vh)] bg-black text-white p-4 pt-[calc(1rem+env(safe-area-inset-top))] pb-[calc(1rem+env(safe-area-inset-bottom))] px-[calc(1rem+env(safe-area-inset-left))] font-sans select-none flex flex-col">
